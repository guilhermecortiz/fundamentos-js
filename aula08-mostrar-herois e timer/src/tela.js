...
class Tela {
  ...
  static gerarStringHTMLPelaImagem(itens) {
    ...
    //ao final, vai concatenar tudos em uma unica string
    //moda de Array para Sting
  ...
  static exibirHerois(nomeDoHeroi, img) {
    ...
    // para cada eleento encontrado na tela, vamos alterar a imagem
  ...
  static iniciarContador() {
    ...
    atualizarTexto()
    // a cada segundo, vai chamar a função atualizar textoPadrao
  ...
  static configurarBotaoMostrarTudo(funcaonOnClick) {
    const btnMostrarTudo = document.getElementById(ID_BTN_MOSTRAR_TUDO)
    btnMostrarTudo.onclick = funcaonOnClick
  }
}